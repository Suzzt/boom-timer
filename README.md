...
到点时整块屏幕碎成一片片，连着上面的文档和窗口一起被螺旋吸进黑洞，
然后停在那儿 —— **必须点一下才复原**。

<table>
<tr>
<td width="50%"><img src="assets/hole-suck.jpg" alt="碎块被吸入" /></td>
<td width="50%"><img src="assets/hole-void.jpg" alt="待命" /></td>
</tr>
<tr>
<td align="center"><b>① 吸走</b><br><sub>屏幕碎块螺旋卷入，被抻长撕碎</sub></td>
<td align="center"><b>② 等你点一下</b><br><sub>不点不走 —— 强制你真的停下来</sub></td>
</tr>
</table>

和爆炸模式最大的差别是**它会挡住你**。爆炸是点击穿透、自动消失，不打断手上的活；
黑洞是吃掉点击、不点不走。久坐提醒本来就该拦一下，但也因此加了三道保险：
点击捕获由前端主动申请（前端出错就还是穿透的）、收尾必定恢复穿透、
Rust 侧 150 秒强制收回。

想要不打扰的版本，在设置里把「到点效果」切回**爆炸**。
